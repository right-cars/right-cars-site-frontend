...
//@ts-expect-error
export default function CarInfo({auction, data, pageId, setIsCarInfoShown}: {
  pageId: string;
...
console.log(data)
  return (
    <div className={cls.wrapper}>
      ...
      />
      {/* @ts-expect-error */}
      <SecondInfoBlock auction={auction} pageId={pageId} setIsCarInfoShown={setIsCarInfoShown}/>
    </div>
  );
}
